...
app.post('/api/admin/qrcode', upload.single('qrcode'), (req, res) => {
  ...
  if (req.file) {
    const base64 = req.file.buffer.toString('base64');
    qrcodeData = 'data:' + req.file.mimetype + ';base64,' + base64;
    isBase64 = true;
  } else if (req.body.qrcodeUrl) {
    qrcodeData = req.body.qrcodeUrl;
  } else if (req.body.qrcodeData) {
